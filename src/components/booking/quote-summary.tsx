...
export function QuoteSummary({ nested = false }: Props = {}) {
  ...
  const body = (
    <>
      {preferredVehicle && (
          <div className="mb-3 flex items-center gap-3 rounded-md border border-primary/30 bg-primary/5 p-2.5">
        ...
        <div className="border-t mt-3 pt-3 flex justify-between font-semibold">
          ...
          <span className="text-lg text-foreground">{formatCurrency(quote.totalAmount)}</span>
        </div>
        ...
        <div className="mt-3 rounded-md border border-emerald-600/30 bg-emerald-50 p-3 dark:border-emerald-400/30 dark:bg-emerald-500/10">
          <div className="flex justify-between text-sm">
            ...
            <span className="font-semibold">{formatCurrency(quote.payOnlineAmount)}</span>
          </div>
