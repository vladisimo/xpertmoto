  ...
  return (
    <PageShell>
      <PageHeader
        eyebrow="Finance"
        title="Categories"
        description="Manage the vehicle categories (scooters, motorbikes, cars) that customers can book. Rates live on the Pricing tab."
        actions={
          <div className="flex gap-2">
            <Button variant="secondary" asChild>
              <Link href="/admin/pricing">Edit rates</Link>
            </Button>
      ...
      <PageSection title="All categories" description="Active categories show on /fleet. Archived ones are hidden but their booking history is preserved.">
        <DataTable
          columns={columns}
          data={categories}
          getRowId={(r) => r.id}
